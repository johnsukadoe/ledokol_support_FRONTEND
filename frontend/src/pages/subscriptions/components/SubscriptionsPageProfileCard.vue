<template>
  <div class="creator-card">
    <div class="creator-info flex justify-between items-center">
      <div>
...
export default defineComponent({
  name: "SubscriptionsPageProfileCard",
  props: ["user", "lang"],
  methods: {
...
.creator-info p.subscribers {
  color: #ff0000;
  font-weight: 700;
}

.creator-info p.posts {
  color: #00ff00;
  font-weight: 700;
}
</style>
