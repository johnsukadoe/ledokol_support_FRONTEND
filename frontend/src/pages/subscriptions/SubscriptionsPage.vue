<script lang="ts">
import { getSubscriptions, unsubscribeCreator } from "@/api/subscriptionAPI.ts";
import CreaterCard from "@/pages/subscriptions/components/SubscriptionsPageProfileCard.vue";
...
export default defineComponent({
  ...
  methods: {
    ...
    async unsubscribe(creator_id: number) {
      this.$confirm(
